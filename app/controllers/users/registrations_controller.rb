class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def sign_up_params
    params.require(:user).permit(:user_type, :email, :password, :password_confirmation, :name, :avatar)
  end

  def account_update_params
    params.require(:user).permit(:user_type, :email, :password, :password_confirmation, :current_password, :name, :avatar)
  end
